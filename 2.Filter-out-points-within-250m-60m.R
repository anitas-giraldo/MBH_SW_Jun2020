...
p1 <- readOGR("~/MBHdesignSW/design4/Bruvs60m_2020-06-02.shp")
...
## p1 ----
p1_matrix <- gWithinDistance(p1, dist = 280, byid = TRUE)
diag(p1_matrix) <- NA
p1_matrix
...
writeOGR( swbruvs, dsn="~/MBHdesignSW/design4", layer=paste( "SW-Bruvs60m_utm", Sys.Date(), sep="_"), driver="ESRI Shapefile", overwrite_layer=TRUE)
writeOGR( swbruvst, dsn="~/MBHdesignSW/design4", layer=paste( "SW-Bruvs60m_latlong", Sys.Date(), sep="_"), driver="ESRI Shapefile", overwrite_layer=TRUE)
